...
<head>
    ...
    <title>Password Reset Successful - TransparaTrack</title>
        ...
        <div class="right-side">
            ...
            <div class="form-container center-content">
                <div class="success-message">
                    ...
                    <h1>Your password has been <span class="highlight-green">successfully reset!</span></h1>
                    <p>You can now log in with your new password.</p>
                    
                    <a href="login.php" class="btn-primary" style="display: inline-block; margin-top: 30px;">Proceed to Login</a>
                </div>
            </div>
        </div>
    </div>
