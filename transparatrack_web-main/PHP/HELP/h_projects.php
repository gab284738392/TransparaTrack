...
<head>
  <meta charset="utf-8">
  <title>Help (Projects) — TransparaTrack</title>
...
<div class="help-content-container">
    ...
    <section class="section-help-guide">
        <h2 class="guide-title">1. Projects Page</h2>

        <div class="guide-image-placeholder">
            <img src="/transparatrack_web/PHP/HELP/assets/7.jpg" alt="Login Page User Guide Screenshot" class="guide-image">
        </div>
     ...
     <section class="section-help-guide">
        <h2 class="guide-title">2. Project Details</h2>

        <div class="guide-image-placeholder">
            <img src="/transparatrack_web/PHP/HELP/assets/8.jpg" alt="Login Page User Guide Screenshot" class="guide-image">
        </div>
        ...
        <table class="guide-table">
          ...
          <tbody>
                <tr>
                    ...
                    <td>A navigational link that returns the user to the main Project List View.</td>
                    <td>Click Back to Projects to return to the list of all project cards.</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Project Photos/Progress Images</td>
                    <td>Images uploaded by the Admin to document the actual progress or completion of the project.</td>
                    <td>View these images to see visual evidence of the work being done.</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>Attachments Section</td>
                    <td>Contains downloadable links to official documents related to the project (e.g., permits, financial reports, sign-offs).</td>
                    <td>Click the downloadable links to view the PDF or other files attached to the project.</td>
                </tr>
            </tbody>
            </tbody>
        </table>
